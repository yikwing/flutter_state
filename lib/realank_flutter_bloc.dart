...
typedef RLKBLoCWidgetBuilder<T> = Widget Function(
...
class RLKBaseBLoC<T> {
  ...
  RLKBaseBLoC(T data) {
    ...
    this._controller = BehaviorSubject<T>();
  }
...
class RLKBLoCProvider extends InheritedWidget {
  ...
  static RLKBaseBLoC of(BuildContext context) =>
      (context.inheritFromWidgetOfExactType(RLKBLoCProvider) as RLKBLoCProvider)
          .bloc;
}
